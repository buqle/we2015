			...
			var pw_bar = $('.pw_bar') ;
				if (pwd==null||pwd==''){
                    pw_bar.css({'width':'0px'})
						 ...
						 switch(S_level){
						   case 0:pw_bar.css({'width':'0px','background':'#FF0000'});
						   case 1:pw_bar.css({'width':'83px','background':'#FF0000'});
						   break;
						   case 2:pw_bar.css({'width':'166px','background':'#FF9900'});
						   break;
						   case 3:pw_bar.css({'width':'249px','background':'#33CC00'});
						   break;
						   default:pw_bar.css({'width':'332px','background':'#33CC00'});
						  }
					 }
				return;
	   }
