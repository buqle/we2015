...
var style=value%3;
    ...
    return this.optional(element) || (!style);
        ...
        $("#"+form_id).validate({
            errorPlacement:function(error,element){error.appendTo(element.siblings('p'))},
            errorElement:'span',
    		rules: {
    			account: {required: true,min:true,decimals:true},
    			lilv: {required: true,min:true,decimals:true},
                times:{required: true,min:true,digits:true,muit3:true}
    		},
    		messages: {
    			account: {required: "请输入借款金额",min:"请输入正确的金额",decimals:"请输入两位小数以内的值"},
    			lilv: {required: "请输入年利率",min:"请输入正确的年利率",decimals:"请输入两位小数以内的值"},
                times:{required: "请输入借款期限",min:"请输入正确的期限",digits:"请输入整数",muit3:"请输入3的倍数"}
    		},
...
exports.getsMonth=function(){
	...
	var todayDate= new Date(),dateStr;
  ...
  //每个月还款额,还款总额,利息,还款本金
    ...
    var tableTr='<table class="load_tab"><tr><th width="10%">期数</th><th width="20%">月还款本息</th><th width="20%">月还款本金</th><th width="15%">利息</th><th width="20%">余额</th><th width="15%">还款时间</th></tr>';
...
exports.getEnd=function(){
	...
	var Year=todayDate.getFullYear(),
  		...
  		Day=todayDate.getDate();//还款时间
      Day=(Day<=9)?("0"+Day):Day;
	var repayAccount,accountAll,interest;//每个月还款额
      repayAccount=accountAll=interest=0;
    var tableTr='<table class="load_tab"><tr><th width="10%">期数</th><th width="20%">月还款本息</th><th width="20%">月还款本金</th><th width="15%">利息</th><th width="20%">余额</th><th width="15%">还款时间</th></tr>';
...
exports.getEndMonth=function(){
	...
	var Year=todayDate.getFullYear(),
  		...
  		Day=todayDate.getDate();//还款时间
      Day=(Day<=9)?("0"+Day):Day;
  var repayAccount,accountAll,interest,capital,yesAccount;
      repayAccount=accountAll=interest=capital=yesAccount=0;
  //每个月还款额,还款总额,利息,还款本金
    var tableTr='<table class="load_tab"><tr><th width="10%">期数</th><th width="20%">月还款本息</th><th width="20%">月还款本金</th><th width="15%">利息</th><th width="20%">余额</th><th width="15%">还款时间</th></tr>';
    	capital = 0 ;
...
exports.getEndDay=function(){
	...
	var Year=todayDate.getFullYear(),
  		...
  		Day=todayDate.getDate();//还款时间
      Day=(Day<=9)?("0"+Day):Day;
  var repayAccount,accountAll,interest;
	   repayAccount=accountAll=interest=0;
  var tableTr='<table class="load_tab"><tr><th width="10%">期数</th><th width="20%">月还款本息</th><th width="20%">月还款本金</th><th width="15%">利息</th><th width="20%">余额</th><th width="15%">还款时间</th></tr>';
     	interest = monthApr*times*account;
    	repayAccount=interest+account;
...
exports.getEndMonths=function(){
	...
	var Year=todayDate.getFullYear(),
  		...
  		Day=todayDate.getDate();//还款时间
      Day=(Day<=9)?("0"+Day):Day;
  var repayAccount,accountAll,interest,capital,repayNext,repayInt;
      repayAccount=accountAll=interest=capital=repayNext=repayInt=0;
  var tableTr='<table class="load_tab"><tr><th width="10%">期数</th><th width="20%">月还款本息</th><th width="20%">月还款本金</th><th width="15%">利息</th><th width="20%">余额</th><th width="15%">还款时间</th></tr>';
    	capital = 0 ;
    	interest = account*monthApr;
    	repayAccount=interest+capital;
