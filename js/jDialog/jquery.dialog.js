...
var jDialog = (function($, undefined){
    ...
    DialogClass.prototype = {
        ...
        _setupContent: function(){
            ...
            if(this.cfg.contentType === 'ajax'){
                var url = this.cfg.content;
                this.cfg.content = $("<div id='jdialog-ajax'><div class='loading_now' style='text-indent: 4em;'>正在努力加载中，请耐心等待...</div></div>")
                    .css({
                        width: "100%",
                        height : "100%",
                        border : "none"
