                ...
                function(ret){
                    ...
                    if(ret.code == 0){
                        $("body").append('<div class="tanchuang"></div>'+
                            ...
                            '<img class="xx" src="/dyweb/dythemes/rhd/actives/autumn/phone/images/x.png">'+
                            '<img class="uu" src="/dyweb/dythemes/rhd/actives/autumn/phone/images/ss.png">'+
                            '<div class="tt"></div>'+
        ...
        rhdapi.getPost(    //weixin/?user&q=get_share_ajax&alias=autumn&methodname=get_mytender
            ...
            function(ret){
                ...
                if(ret.code == 0){
                    ...
                    $("body").append('<div class="tanchuang"></div>'+
                        '<div class="tc-box">'+
                        '<img class="xx" src="/dyweb/dythemes/rhd/actives/autumn/phone/images/xx.png">'+
                        '<div class="liip_s liip_s1">'+
                        '<div class="header"><img class="img6" src="/dyweb/dythemes/rhd/actives/autumn/phone/images/11.png"></div>'+
                        ...
                        '</div></div>' +
                        '<p class="rr">你目前的金叶子：<span class="shulixang">'+num+'</span></p>'+
                        '</div>'+
                        '</div>');
            ...
            function(ret){
                ...
                if(ret.code == 0){
                    ...
                    $("body").append('<div class="tanchuang"></div>'+
                        ...
                        '<img class="xx" src="/dyweb/dythemes/rhd/actives/autumn/phone/images/xx.png">'+
                        '<div class="liip_s liip_s1">'+
                        '<div class="header"><img class="img6" src="/dyweb/dythemes/rhd/actives/autumn/phone/images/12.png"></div>'+
                        '<div class="heads"><span>兑换商品</span><span>兑换时间</span><span>所用金叶子</span></div>'+
                        '<div class="dl1">'+
                        '<div class="lun-slilld" id="myduihuan">'+
                        '</div></div>' +
                        '<p class="rr">你目前的金叶子:<span class="sl">'+num+'</span></p>'+
                        '</div>'+
                        '</div>');
